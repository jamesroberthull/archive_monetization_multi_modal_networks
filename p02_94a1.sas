*********************************************************************
**     Program Name: /home/jhull/nangrong/prog_sas/p02_nets/1994/p02_94a1.sas
**     Programmer: james r. hull
**     Start Date: 2011 03 09
**     Purpose:
**        1.) Create A1 = PAID RICE NETWORKS # WORKERS
**
**     Input Data:
...
**
**     Output Data:
**        1.) /home/jhull/nangrong/data_paj/1994/a1/vXX94a1.net
**            
**     Notes: 
**        1.)
**
...
%let f=94a1;  ** names file (allows portability) **;
%let y=94; 
...
data work&f.07;
     ...
     *Fix data coding errors*;
     ...
     if HELPHHID="0582041" then HELPHHID="0582014"; 
     if HELPHHID="0742014" then HELPHHID="0742041"; 
     if HELPHHID="1012014" and V84="41" then HELPHHID="1012041";   ** This is so ridiculous... **;
...
proc iml;
     ...
     %let p1=%quote(/home/jhull/nangrong/data_paj/1994/a1-net/v0);
     %let p2=%quote(94a1.net);
     use r94_p&i;
     read all var{
...
proc iml;
     %include '/home/jhull/public/span/adjval.mod';
     %include '/home/jhull/public/span/pajwrite.mod';
     %let p1=%quote(/home/jhull/nangrong/data_paj/1994/a1-net/v);
     %let p2=%quote(94a1.net);
...
%do i=1 %to &numvill;
    data _null_ ;
         %let p1=%quote(/home/jhull/nangrong/data_paj/1994/a1-adj/v0);
         %let p2=%quote(94a1.adj);
         set adj0&i;
         file "&p1.&i.&p2"  lrecl=1000;
         put (_ALL_) (+0);
run;
    data _null_ ;
         %let p3=%quote(/home/jhull/nangrong/data_paj/1994/a1-id/v0);
         %let p4=%quote(94a1.id);
         set id0&i;
...
%do i=10 %to &numvill;  
    data _null_ ;
         %let p1=%quote(/home/jhull/nangrong/data_paj/1994/a1-adj/v);
         %let p2=%quote(94a1.adj);
         set adj&i;
         file "&p1.&i.&p2"  lrecl=1000;
         put (_ALL_) (+0);
run;
    data _null_ ;
         %let p3=%quote(/home/jhull/nangrong/data_paj/1994/a1-id/v);
         %let p4=%quote(94a1.id);
         set id&i;
         file "&p3.&i.&p4"  lrecl=10000;
         put (_ALL_) (+0);
