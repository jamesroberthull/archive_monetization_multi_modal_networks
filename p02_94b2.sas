*********************************************************************
**     Program Name: /home/jhull/nangrong/prog_sas/p02_nets/1994/p02_94b2.sas
...
**
**     Output Data:
**        1.) /home/jhull/nangrong/data_paj/1994/b2/vXX94b2.net
**            
**     Notes: 
**        1.) 
**
...
%let f=94b2;  ** names file (allows portability) **;
%let y=94; 
...
***********************************************************************************
** FEMALES: Create 51 VALUED adjacency matrices, one for each village - siblings **
***********************************************************************************;
...
proc iml;
     ...
     %let p1=%quote(/home/jhull/nangrong/data_paj/1994/b2-net/v0);
     %let p2=%quote(94b2.net);
     use v94_fs&i;
     ...
     r94_fs=adjval(snd,rcv,val);
     id=r94_fs[,1];
     r94_fs=r94_fs[,2:ncol(r94_fs)];
     adj=r94_fs;
     file "&p1.&i.&p2";
...
proc iml;
     ...
     %include '/home/jhull/public/span/pajwrite.mod';
     %include '/home/jhull/public/span/uciwrite.mod';
     %let p1=%quote(/home/jhull/nangrong/data_paj/1994/b2-net/v);
     %let p2=%quote(94b2.net);
     use v94_fs&i;
     read all var{SIBHH01 SIBHH02 SIBHH03 SIBHH04 SIBHH05
                  SIBHH06 SIBHH07 SIBHH08 SIBHH09 SIBHH10
...
%do i=1 %to &numvill;
    data _null_ ;
         %let p1=%quote(/home/jhull/nangrong/data_paj/1994/b2-adj/v0);
         %let p2=%quote(94b2.adj);
         set adj0&i;
         file "&p1.&i.&p2"  lrecl=1000;
         put (_ALL_) (+0);
run;
    data _null_ ;
         %let p3=%quote(/home/jhull/nangrong/data_paj/1994/b2-id/v0);
         %let p4=%quote(94b2.id);
         set id0&i;
...
%do i=10 %to &numvill;  
    data _null_ ;
         %let p1=%quote(/home/jhull/nangrong/data_paj/1994/b2-adj/v);
         %let p2=%quote(94b2.adj);
         set adj&i;
         file "&p1.&i.&p2"  lrecl=1000;
         put (_ALL_) (+0);
run;
    data _null_ ;
         %let p3=%quote(/home/jhull/nangrong/data_paj/1994/b2-id/v);
         %let p4=%quote(94b2.id);
         set id&i;
         file "&p3.&i.&p4"  lrecl=10000;
         put (_ALL_) (+0);
