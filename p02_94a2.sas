*********************************************************************
**     Program Name: /home/jhull/nangrong/prog_sas/p02_nets/1994/p02_94a2.sas
**     Programmer: james r. hull
**     Start Date: 2011 03 09
**     Purpose:
**        1.) Create A2 = UNPAID RICE NETWORKS # WORKERS
**
**     Input Data:
...
**
**     Output Data:
**        1.) /home/jhull/nangrong/data_paj/1994/a2/vXX94a2
**            
**     Notes: 
**        1.) 
**
...
%let f=94a2;  ** names file (allows portability) **;
%let y=94; 
...
proc iml;
     ...
     %let p1=%quote(/home/jhull/nangrong/data_paj/1994/a2-net/v0);
     %let p2=%quote(94a2.net);
     use r94_u&i;
     read all var{
     ...
     r94_u=adjval(snd,rcv,val);
     id=r94_u[,1];
     r94_u=r94_u[,2:ncol(r94_u)];
     adj=r94_u;
     file "&p1.&i.&p2";
...
proc iml;
     %include '/home/jhull/public/span/adjval.mod';
     %include '/home/jhull/public/span/pajwrite.mod';
     %let p1=%quote(/home/jhull/nangrong/data_paj/1994/a2-net/v);
     %let p2=%quote(94a2.net);
     use r94_u&i;
     read all var{
                  UID_H11 UID_H12 UID_H13 UID_H14 UID_H15
...
%do i=1 %to &numvill;
    data _null_ ;
         %let p1=%quote(/home/jhull/nangrong/data_paj/1994/a2-adj/v0);
         %let p2=%quote(94a2.adj);
         set adj0&i;
         file "&p1.&i.&p2"  lrecl=1000;
         put (_ALL_) (+0);
run;
    data _null_ ;
         %let p3=%quote(/home/jhull/nangrong/data_paj/1994/a2-id/v0);
         %let p4=%quote(94a2.id);
         set id0&i;
...
%do i=10 %to &numvill;  
    data _null_ ;
         %let p1=%quote(/home/jhull/nangrong/data_paj/1994/a2-adj/v);
         %let p2=%quote(94a2.adj);
         set adj&i;
         file "&p1.&i.&p2"  lrecl=1000;
         put (_ALL_) (+0);
run;
    data _null_ ;
         %let p3=%quote(/home/jhull/nangrong/data_paj/1994/a2-id/v);
         %let p4=%quote(94a2.id);
         set id&i;
         file "&p3.&i.&p4"  lrecl=10000;
         put (_ALL_) (+0);
