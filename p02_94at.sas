***********************************************************************************
**     Program Name: /home/jhull/nangrong/prog_sas/p02_nets/1994_att/p02_94at.sas
**     Programmer: james r. hull
**     Start Date: 2011 03 09
**     Purpose:
**        1.) Create 1994 Household Attribute Files By Village
**
**     Input Data:
...
**
**     Output Data:
**        1.) /home/jhull/nangrong/data_paj/1994_att/vXX94at
**            
**     Notes: 
**        1.) ADD LIST: HHTYPE94 
...
%let f=94at;  ** names file (allows portability) **;
%let y=94; 
...
%do i=1 %to &numvill;
    data _null_ ;
         %let p1=%quote(/home/jhull/nangrong/data_paj/1994_att/v0);
         %let p2=%quote(94at.txt);
         set r94_a&i;
         file "&p1.&i.&p2";
...
%do i=10 %to &numvill;
    data _null_ ;
         %let p1=%quote(/home/jhull/nangrong/data_paj/1994_att/v);
         %let p2=%quote(94at.txt);
         set r94_a&i;
         file "&p1.&i.&p2";
         put RICE IS_HH ALL_PWRK ALL_PWAG ALL_UWRK ALL_UWAG ALL_WRKS ALL_WAGE;
