###################################################################
# PROGRAM NAME: /home/jhull/nangrong?prog_r/p02_nets/p02_9401.R
...
for(i in seq(1,9,1)) {
    ...
    f.adj.a1<-as.name(paste("/home/jhull/nangrong/data_paj/1994/a1-adj/v0",i,"94a1.adj",sep=""))   #Raw Adjaceny File
    f.adj.a2<-as.name(paste("/home/jhull/nangrong/data_paj/1994/a2-adj/v0",i,"94a2.adj",sep=""))   #Raw Adjaceny File
    f.adj.b1<-as.name(paste("/home/jhull/nangrong/data_paj/1994/b1-adj/v0",i,"94b1.adj",sep=""))   #Raw Adjaceny File
    f.adj.b2<-as.name(paste("/home/jhull/nangrong/data_paj/1994/b2-adj/v0",i,"94b2.adj",sep=""))   #Raw Adjaceny File

    # Define Path Names for ID Sets
    f.id.a1<-as.name(paste("/home/jhull/nangrong/data_paj/1994/a1-id/v0",i,"94a1.id",sep=""))   #Raw ID Number File
    f.id.a2<-as.name(paste("/home/jhull/nangrong/data_paj/1994/a2-id/v0",i,"94a2.id",sep=""))   #Raw ID Number File
    f.id.b1<-as.name(paste("/home/jhull/nangrong/data_paj/1994/b1-id/v0",i,"94b1.id",sep=""))   #Raw ID Number File
    f.id.b2<-as.name(paste("/home/jhull/nangrong/data_paj/1994/b2-id/v0",i,"94b2.id",sep=""))   #Raw ID Number File


    f.att.all<-as.name(paste("/home/jhull/nangrong/data_paj/1994_att/v0",i,"94at.txt",sep=""))  #Text Attribute File

    f.png.loc<-as.name(paste("/home/jhull/nangrong/png_r/p02_nets/1994/a1-b2/v0",i,"94a1.png",sep=""))  #Saved PNG Graphic File
    f.title<-as.name(paste("1994: Village ",i,": Multiple Networks",sep=""))                #Title for Saved PNG
...
for(i in seq(10,51,1)) {
    ...
    # Define Path Names for Adjacency Matrices
    f.adj.a1<-as.name(paste("/home/jhull/nangrong/data_paj/1994/a1-adj/v",i,"94a1.adj",sep=""))   #Raw Adjaceny File
    f.adj.a2<-as.name(paste("/home/jhull/nangrong/data_paj/1994/a2-adj/v",i,"94a2.adj",sep=""))   #Raw Adjaceny File
    f.adj.b1<-as.name(paste("/home/jhull/nangrong/data_paj/1994/b1-adj/v",i,"94b1.adj",sep=""))   #Raw Adjaceny File
    f.adj.b2<-as.name(paste("/home/jhull/nangrong/data_paj/1994/b2-adj/v",i,"94b2.adj",sep=""))   #Raw Adjaceny File

    # Define Path Names for ID Sets
    f.id.a1<-as.name(paste("/home/jhull/nangrong/data_paj/1994/a1-id/v",i,"94a1.id",sep=""))   #Raw ID Number File
    f.id.a2<-as.name(paste("/home/jhull/nangrong/data_paj/1994/a2-id/v",i,"94a2.id",sep=""))   #Raw ID Number File
    f.id.b1<-as.name(paste("/home/jhull/nangrong/data_paj/1994/b1-id/v",i,"94b1.id",sep=""))   #Raw ID Number File
    f.id.b2<-as.name(paste("/home/jhull/nangrong/data_paj/1994/b2-id/v",i,"94b2.id",sep=""))   #Raw ID Number File


    f.att.all<-as.name(paste("/home/jhull/nangrong/data_paj/1994_att/v",i,"94at.txt",sep=""))  #Text Attribute File

    f.png.loc<-as.name(paste("/home/jhull/nangrong/png_r/p02_nets/1994/a1-b2/v",i,"94a1.png",sep=""))  #Saved PNG Graphic File
    f.title<-as.name(paste("1994: Village ",i,": Multiple Networks",sep=""))                #Title for Saved PNG
